...
function(mn_generate_test_driver driver_exe_name namespace)
    ...
    target_link_libraries(${driver_exe_name} PRIVATE ${TARGET_PREFIX_STR} ${namespace})
...
function(mn_test_single c_file_name test_case_name target_link_libs)
	...
	target_compile_definitions(${TEST_SINGLE_TARGET} PRIVATE -DAWS_UNSTABLE_TESTING_API)
endfunction()
